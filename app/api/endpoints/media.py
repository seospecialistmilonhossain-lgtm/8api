        ...
        MediaProviderResponse(
            ...
            categories=[
                MediaCategoryResponse(
                    ...
                    title="World TV",
                    type="live",
                    logo_url="https://apphubx.store/apphub/media/world.svg",
                    color_hex="#2196F3",
                ...
                MediaCategoryResponse(
                    ...
                    title="Movies",
                    type="vod",
                    logo_url="https://apphubx.store/apphub/media/netflix.ico",
                    color_hex="#9C27B0",
                ...
                MediaCategoryResponse(
                    ...
                    title="Sports",
                    type="live",
                    logo_url="https://upload.wikimedia.org/wikipedia/commons/0/0c/Sport_balls.svg",
                    color_hex="#4CAF50",
